<template>
  <div class="p-2">
        ...
        <a-row :gutter="24">
          ...
          <a-col :lg="6">
            <a-form-item name="ipaddress">
              <template #label><span title="系统地址">系统地址</span></template>
    ...
    <!-- 表单区域 -->
    <TSPageModal ref="registerModal" @success="handleSuccess" />
  </div>
</template>

<script lang="ts" name="systemRecords-tSPage" setup>
  ...
  function getTableAction(record) {
    return [
      ...
      {
        label: '前往',
        onClick: handGo.bind(null, record),
      },
      {
        label: '删除',
        popConfirm: {
